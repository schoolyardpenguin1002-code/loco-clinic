  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        "ご予約は公式LINEから承っております。ご不明な点やご相談も、公式LINEのトークからお気軽にお送りください。順番にお返事いたします。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "お車ですと高崎環状線沿いです。近くには群馬銀行様、ヤマダ電機様、ユニクロ様、GU様、浜尻小学校様、浜尻南児童公園がございます。詳細はGoogle マップをご参照くださいませ。電車ですと高崎問屋町駅から徒歩9分程度です。",
    },
    {
